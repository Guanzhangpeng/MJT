...
+(UIViewController*)createViewControllerWithDictAndPush:(NSDictionary*)dict
{
    ...
    if ([vc isKindOfClass:[MjtMessageListVC class]]) {
        MjtMessageListVC *  messageVC = [[MjtMessageListVC alloc]init];
        messageVC.messageType = [[NSString stringWithFormat:@"%@",dict[@"messageType"]] intValue];
        vc = messageVC;
    }
