...
- (void)addTopBarItem {
    ...
    [topBarItem setTitleColor:MJTColorA(43, 43, 43, 1) forState:UIControlStateNormal];
    [topBarItem setTitleColor:MJTColorA(255, 85, 0, 1) forState:UIControlStateSelected];
...
- (UIView *)separateLine {
    ...
    separateLine.backgroundColor = MJTColorA(222, 222, 222, 1);
    return separateLine;
}
