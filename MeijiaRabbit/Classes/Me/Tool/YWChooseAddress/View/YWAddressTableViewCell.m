...
- (void)setItem:(YWAddressModel *)item {
    ...
    CGSize fontSize = [UIView getSizeByString:item.name sizeConstraint:CGSizeMake(ScreenWidth, YWFontH) font:[UIFont systemFontOfSize:16]];
    _addressNameLabel.frame = CGRectMake(20, 10, fontSize.width, YWFontH);
    _addressNameLabel.textColor = item.isSelected ? MJTColorA(255, 85, 0, 1) : [UIColor blackColor];
